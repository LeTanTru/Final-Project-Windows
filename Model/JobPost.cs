...
namespace Find_Job_Management.Model {
    public class JobPost {
        ...
        public int RecruitmentNumber {
            get => recruitmentNumber; set => recruitmentNumber = value;
        }
        public int Salary {
        ...
        public string Requirement {
            get => requirement; set => requirement = value;
        }
        public string Prioritize {
            get => prioritize; set => prioritize = value;
        }
        public string Benefit {
            get => benefit; set => benefit = value;
        }
        public DateTime PostDate {
            get => postDate; set => postDate = value;
        }
        public DateTime ExpireDate {
            get => expireDate; set => expireDate = value;
        }
        public string Address {
            get => address; set => address = value;
        }
        public int YearExperienceId {
            get => yearExperienceId; set => yearExperienceId = value;
        }
        public int LocationId {
            get => locationId; set => locationId = value;
        }
        public int CompanyId {
            get => companyId; set => companyId = value;
        }
